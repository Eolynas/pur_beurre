...
from product.open_food_fact.request_sql import insert_product
...
class TestProductApp(TestCase):
    ...
    def test_recover_api_open_food_fact(self, mock_get):
        ...
        assert product[0]["nutriscore_score"] == '8'
    ...
    def test_insert_data_in_db(self):
        ...
        """
        example_dict_product = [{'name': 'Pizza 4 fromage',
                                'stores': None,
        ...
        insert = insert_product(example_dict_product)
